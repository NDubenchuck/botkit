...
controller.hears('shop','message',  async(bot, message) => {
  ...
  controller.hears(async(message) =>
    await (message.quick_replies.payload === 'Music' || message.quick_replies.payload === 'HardGood' || message.quick_replies.payload === 'BlackTie' || message.quick_replies.payload === 'Movie'
